...
import com.example.thriftuniversecrud.Model.Cart;
import com.example.thriftuniversecrud.Prevalent.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        final DatabaseReference cartListRef = FirebaseDatabase.getInstance().getReference(firebaseAuth.getUid()).child("cart list");
    ...
    private void CheckOrderState()
    {
        ...
        firebaseAuth.getCurrentUser();
        ordersRef = FirebaseDatabase.getInstance().getReference(firebaseAuth.getUid()).child("Orders");
